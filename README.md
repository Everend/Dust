# July Journey
该项目为旅游资讯网站。请在node环境下运行app.js文件，并通过访问localhost:3000/查看。<br>
...
<img src="./preview/main1.png"width= "49%" border=1 solid red;"><img src="./preview/main2.png" width="50%"float="left">
